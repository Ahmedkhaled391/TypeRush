          ...
          >
            ...
            <div className="mt-9 space-y-5">
              <div className="name flex flex-col gap-2.5">
                ...
                {nameError && (
                  <div className="alert-name text-xs font-semibold text-red-400">
                    {nameError}
                  </div>
                )}
                <div className="field relative text-slate-900 dark:text-white/35">
                  ...
                  <input
                    ...
                    onBlur={() => setNameError(getNameError(formData.name))}
                    type="text"
              ...
              <div className="mail flex flex-col gap-2.5">
                ...
                {emailError && (
                  <div className="alert-mail text-xs font-semibold text-red-400">
                    {emailError}
                  </div>
                )}
                <div className="field relative text-slate-900 dark:text-white/35">
              ...
              <div className="name flex flex-col gap-2.5">
                ...
                {passError && (
                  <div className="alert-pass text-xs font-semibold text-red-400">
                    {passError}
                  </div>
                )}
                <PasswordInput
              ...
              <div className="name flex flex-col gap-2.5">
                ...
                {confirmPassError && (
                  <div className="alert-confirm-pass text-xs font-semibold text-red-400">
                    {confirmPassError}
                  </div>
                )}
                <PasswordInput
