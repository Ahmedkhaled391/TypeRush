          ...
          >
            ...
            <div className="mt-9 space-y-5">
              <div className="mail flex flex-col gap-2.5">
                <label
                  htmlFor="email"
                  className="text-xs font-semibold uppercase tracking-[0.14em] text-slate-900 dark:text-white/45"
                >
                  Email
                </label>
                <div className="field relative text-slate-900 dark:text-white/35">
                  <img
                    src={emailicon}
                    alt="mail icon"
                    className="absolute left-4 top-1/2 h-4 w-4 -translate-y-1/2 opacity-75"
                  />
                  <input
                    id="email"
                    name="email"
                    ...
                    className="h-13 w-full rounded-xl border border-white/4 bg-panel px-4 pl-11 text-sm text-slate-900 dark:text-white outline-none transition placeholder:text-slate-500 dark:placeholder:text-slate-300 focus:border-white/10 dark:focus:bg-[#232933]"
                  />
                </div>
              </div>
            ...
            <div className="mt-9 text-center">
              ...
              <button
                ...
                className="w-full rounded-2xl bg-linear-to-r from-light-mint-green to-vibrant-mint-green p-4 text-base font-black tracking-tight text-dark-mint-green shadow-[0_16px_35px_rgba(0,252,154,0.24)] transition-transform duration-200 hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-70"
              >
              ...
              <p className="paragraph-muted-sm mt-3 text-base">
                ...
                <Link
                  to="/register"
                  className="mx-1 font-semibold text-vibrant-mint-green"
                >
                  Sign up
                </Link>
              </p>
